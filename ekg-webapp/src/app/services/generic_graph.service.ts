...
export class GenericGraphService {
    ...
    */
    public getGraph(type: string, limit: number | any): Observable<any> {
        return this.httpClient.post(`http://127.0.0.1:8080/api/v2/complete-graph?limit=${limit}`, { 'standard_graph': type });
    }
}