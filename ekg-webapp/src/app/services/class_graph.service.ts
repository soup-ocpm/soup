...
export class ClassGraphService {
  ...
  public createClassGraph(formData: FormData, filteredColumn: string[]): Observable<any> {
    ...
    return this.httpClient.post('http://127.0.0.1:5000/api/v2/graph-class', formData);
  }
  ...
  public getClassNodes(): Observable<any> {
    return this.httpClient.get('http://127.0.0.1:5000/api/v2/graph-class/nodes/class');
  }
  ...
  public getClassGraph(): Observable<any> {
    return this.httpClient.get('http://127.0.0.1:5000/api/v2/graph-class');
  }
  ...
  public deleteClassGraph(): Observable<any> {
    return this.httpClient.delete('http://127.0.0.1:5000/api/v2/graph-class');
  }
